 ...
 */
   ...
   * Support bases 2 to 16 by specifying the integer value of the base you wish to convert to (base).
   *
   * @param data number to convert passed in as a signed 32-bit integer
   * @param ARG
   * @param ARG
   *
   * @return RETTYPE.
